export default {
  ...
  item: {
    ...
    create: {
      button: {
        ...
        disabled:
          "Sel.lecciona una de les bases de dades: BETA, BITECA o BITAGAP.",
      },
  ...
  privacyPolicy: {
    ...
    tooltip:
      "Utilitzem galetes estrictament necessàries: aquestes cookies són essencials perquè navegueu pel lloc web i utilitzeu les seves funcions, com ara accedir a àrees segures del lloc o recordar l'idioma escollit.",
    consent: {
    ...
    comments: {
      ...
      subtitleDesc:
        "aquestes dades es recullen quan deixeu un comentari i es mostren al lloc web.",
    ...
    retentionPeriod: {
      ...
      subtitleDesc:
        "les dades esmentades es conserven indefinidament perquè puguem reconèixer i aprovar qualsevol comentari de seguiment automàticament en lloc de mantenir-los en una cua de moderació.",
    },
    legitimateInterest: {
    ...
    embedContent: {
      ...
      desc:
        "Els articles del lloc web poden incloure contingut incrustat (per exemple, vídeos, gràfics, etc.). El contingut incrustat d'altres llocs web es comporta exactament de la mateixa manera que si el visitant hagués visitat l'altre lloc web. <br/> <br/>\n" +
    ...
    rights: {
      ...
      data:
        "• Dret a retirar el consentiment <br/>\n" +
        "• El dret d'accés<br/>\n" +
        "• Dret a supressió<br/>\n" +
  ...
  messages: {
    error: {
      ...
      modification: {
        failed:
          "L'etiqueta i la descripció del codi d'idioma en no poden tenir el mateix valor.",
      },
      creation: {
        pbid_already_exists:
          'El PhiloBiblon ID "{pbid}" ja existeix en {item}.',
      },
    },
    success: {
