    ...
    form: {
      common: {
        ...
        date: {
          ...
          error: {
            invalid_date: 'Format de data no vàlid. Si us plau, utilitzeu AAAA, AAAA-MM, AAAA-MM-DD, MM-DD o DD-MM.',
            invalid_year: "Any no vàlid. Si us plau, introduïu un any fins a l'any actual.",
            invalid_month: 'Mes no vàlid. El mes ha de ser entre 1 i 12.',
            invalid_day: 'Dia no vàlid. El dia ha de ser vàlid per al mes indicat.'
          }
        },
        personal_name: {
          label: 'Nom personal',
      ...
      bibid: {
        ...
        locations: {
          label: 'Localització d’exemplars',
          hint: ''
        },
