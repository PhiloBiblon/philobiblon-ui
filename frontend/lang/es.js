export default {
  ...
  item: {
    ...
    create: {
      button: {
        ...
        disabled:
          "Seleccione una de las bases de datos: BETA, BITECA o BITAGAP.",
      },
    ...
    related: {
      ...
      texid: {
        uniform_title: "Testimonios textuales",
        related_uniform_titles: "Testimonios textuales relacionados",
      },
      bibid: {
  ...
  privacyPolicy: {
    ...
    tooltip:
      "Usamos cookies estrictamente necesarias: estas cookies son esenciales para que usted pueda navegar por el sitio web y utilizar sus funciones, como acceder a áreas seguras del sitio o recordar el idioma seleccionado.",
    consent: {
    ...
    comments: {
      title: "Comentarios",
      subtitle:
        "Nombre, dirección de correo electrónico, contenido del comentario",
      subtitleDesc:
        "Estos datos se recopilan cuando usted deja un comentario y se muestran en el sitio web.",
    ...
    retentionPeriod: {
      ...
      subtitleDesc:
        "Los datos antes mencionados se conservan indefinidamente para que podamos reconocer y aprobar automáticamente los comentarios posteriores en lugar de mantenerlos en una cola de moderación.",
    },
    legitimateInterest: {
    ...
    embedContent: {
      ...
      desc:
        "Los artículos del sitio web pueden incluir contenido incrustado (por ejemplo, videos, gráficos, etc.). El contenido incrustado de otros sitios web se comporta exactamente de la misma manera que si el visitante hubiera visitado el otro sitio web. <br/> <br/>\n" +
    ...
    rights: {
      ...
      data:
        "• El derecho a retirar el consentimiento<br/>\n" +
  ...
  messages: {
    error: {
      ...
      inputs: {
        ...
        claim_value_missing:
          'Please fill in the claim value for "{propertyLabel}"',
        qualifier_key_missing:
          'A qualifier property is missing in the claim "{claimLabel}" for "{propertyLabel}"',
        qualifier_value_missing:
          'Some qualifier(s) value are missing in the claim "{claimLabel}" for "{propertyLabel}"',
      },
      modification: {
        failed:
          "La etiqueta y la descripción del código de idioma en no pueden tener el mismo valor.",
      },
      creation: {
