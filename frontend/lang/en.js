export default {
  ...
  privacyPolicy: {
    ...
    tooltip:
      "We are using strictly necessary cookies — These cookies are essential for you to browse the website and use its features, such as accessing secure areas of the site or remember the selected language.",
    consent: {
    ...
    retentionPeriod: {
      ...
      subtitleDesc:
        "the aforementioned data is retained indefinitely so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue.",
    },
    legitimateInterest: {
    ...
    embedContent: {
      ...
      desc:
        "Articles on the Website may include embedded content (e.g. videos, charts, etc.). Embedded content from other websites behaves in the exact same way as if the visitor had visited the other website. <br/> <br/>\n" +
  ...
  messages: {
    error: {
      ...
      creation: {
        pbid_already_exists:
          'PhiloBiblon ID "{pbid}" already exists in {item}.',
      },
    },
    success: {
