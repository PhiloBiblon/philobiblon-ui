export default {
  ...
  privacyPolicy: {
    ...
    tooltip:
      "Estamos a utilizar cookies estritamente necessários — Estes cookies são essenciais para que possa navegar no site e utilizar as suas funcionalidades, como o acesso a áreas seguras do site ou lembre-se do idioma selecionado.",
    consent: {
    ...
    comments: {
      ...
      subtitleDesc:
        "estes dados são recolhidos quando deixa um comentário e apresentados no Site.",
    ...
    retentionPeriod: {
      ...
      subtitleDesc:
        "os dados acima mencionados são retidos indefinidamente para que possamos reconhecer e aprovar quaisquer comentários de acompanhamento automaticamente, em vez de os manter numa fila de moderação.",
    },
    legitimateInterest: {
    ...
    embedContent: {
      ...
      desc:
        "Os artigos no Site podem incluir conteúdo incorporado (por exemplo, vídeos, gráficos, etc.). O conteúdo incorporado de outros sites comporta-se exatamente da mesma forma como se o visitante tivesse visitado o outro site. <br/> <br/>\n" +
    ...
    rights: {
      ...
      data:
        "• O direito de retirar o consentimento <br/>\n" +
  ...
  messages: {
    error: {
      ...
      modification: {
        failed:
          "O rótulo e a descrição do código do idioma en não podem ter o mesmo valor.",
      },
      creation: {
