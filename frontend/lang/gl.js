export default {
  ...
  item: {
    ...
    create: {
      button: {
        ...
        disabled:
          "Seleccione unha das bases de datos: BETA, BITECA ou BITAGAP.",
      },
  ...
  privacyPolicy: {
    ...
    tooltip:
      "Estamos a usar cookies estrictamente necesarias: estas cookies son esenciais para que navegues polo sitio web e utilices as súas funcións, como acceder a áreas seguras do sitio ou lembrar o idioma seleccionado.",
    consent: {
    ...
    comments: {
      ...
      subtitleDesc:
        "estes datos recóllense cando deixa un comentario e aparecen no sitio web.",
    ...
    retentionPeriod: {
      ...
      subtitleDesc:
        "os datos mencionados consérvanse indefinidamente para que poidamos recoñecer e aprobar calquera comentario de seguimento automaticamente en lugar de mantelos nunha cola de moderación.",
    },
    legitimateInterest: {
    ...
    embedContent: {
      ...
      desc:
        "Os artigos do sitio web poden incluír contido incorporado (por exemplo, vídeos, gráficos, etc.). O contido incrustado doutros sitios web compórtase exactamente do mesmo xeito que se o visitante visitara o outro sitio web. <br/> <br/>\n" +
    ...
    rights: {
      ...
      data:
        "• Dereito a retirar o consentimento <br/>\n" +
  ...
  messages: {
    error: {
      ...
      modification: {
        failed:
          "A etiqueta e a descrición do código de idioma gl non poden ter o mesmo valor.",
      },
      creation: {
