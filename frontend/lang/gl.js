    ...
    form: {
      common: {
        ...
        date: {
          ...
          error: {
            invalid_date: 'Formato de data non válido. Emprega AAAA, AAAA-MM, AAAA-MM-DD, MM-DD ou DD-MM.',
            invalid_year: 'Ano non válido. Introduce un ano ata o ano actual.',
            invalid_month: 'Mes non válido. O mes debe estar entre 1 e 12.',
            invalid_day: 'Día non válido. O día debe ser válido para o mes indicado.'
          }
        },
        personal_name: {
          label: 'Nome persoal',
