  ...
  menu: {
    item: {
      ...
      privacyPolicy: {
        ...
        tooltip: 'Cookies estritamente necesarias: estas cookies son esenciais para que navegues polo sitio web e utilices as súas funcións, como acceder a áreas seguras do sitio. As cookies que permiten ás tendas web gardar os teus artigos na túa cesta mentres compras en liña son un exemplo de cookies estritamente necesarias. Estas cookies xeralmente serán cookies de sesión propias. Aínda que non é necesario obter o consentimento para estas cookies, débese explicar ao usuario o que fan e por que son necesarias.',
        consent: {
